...
- kártya háttere fehér, sarkai lekerekítettek és szegélyezet a szemantikus token használatával.
...
Hozd létre a kártyákhoz tartozó rácsrendszer:
...
- `absolute inset-0 opacity-10`: az SVG-ket 10%-os opacity (90%-os áttetszőséget jelenet) tölti ki a szekciót — finom textúra, nem tartalom.
...
```
Megjelenik egy tömör zöld sáv az elcímmel együtt.
...
Az 1. workshop alkalmával még nem ismertűk a töréspontok használatát és nem figyeltük, hogy mennyire reszponzívak az egyes részek.
